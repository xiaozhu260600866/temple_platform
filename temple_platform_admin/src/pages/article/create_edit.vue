<template>
	<section v-if="data.show">
		<el-form :model="ruleForm" ref="ruleForm" label-width="110px" class="demo-ruleForm create-box">
			...
			<el-form-item label="文章类型" prop="type" :rules="[{ required: true, message: '文章类型不能为空'},]">
			  <el-select v-model="ruleForm.type" placeholder="请选择类型">
				<el-option label="文章" value="article"></el-option>
				<el-option label="url" value="url"></el-option>
			  </el-select>
			</el-form-item>
			<el-form-item label="跳转url" prop="gotourl" :rules="[{ required: true, message: '新闻标题不能为空'},]" v-if="ruleForm.type == 'url'">
				<el-input v-model="ruleForm.gotourl" style="width:40%"></el-input>
			</el-form-item>
