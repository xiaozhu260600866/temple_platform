	...
	<div>
		<dx-table :data="data" :globalData="globalData" @submitBeforeCallBack="submitBeforeCallBack" operateWidth="100">
			...
			<div slot="tableLeft" slot-scope="scope">
				 <el-button type="primary"  @click="printfAll(scope.row)" style="margin-left:10px;padding: 12px 40px;" :disabled="scope.row.length===0 " v-if="data.query.printf==0">批量打印</el-button>
			</div>
        </dx-table>
	</div>
</template>
<script type="text/javascript">
	import globalData from "./layouts/auto_printf.js";
