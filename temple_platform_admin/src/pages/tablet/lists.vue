<template>
	<div>
		<dx-table :data="data" :globalData="globalData" @submitBeforeCallBack="submitBeforeCallBack" operateWidth="250px">
			<div slot="header">
...
<script type="text/javascript">
	import globalData from "./layouts/tablet.js";

	export default {
		data() {
			return {
				formAction: "/admin/tablet/lists",
