<template>
	<div>
		<dx-table :data="data" :globalData="globalData" @submitBeforeCallBack="submitBeforeCallBack" operateWidth="1">
			...
			<!-- <div slot="append_table_sort" slot-scope="scope">
				<el-input size="small" v-model="scope.row.sort"  @change="editField(scope.row,'sort')"></el-input>
			</div> -->
		 </dx-table>
	</div>
</template>
<script type="text/javascript">
	import globalData from "./layouts/room_orders.js";

	export default {
		data() {
			return {
				formAction: "/admin/roomAppointment/order-lists",
