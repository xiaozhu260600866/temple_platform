<template>
    <!-- 上传规格 -->
    <el-dialog title="设置房号" :visible.sync="dialogVisible" size="tiny" :before-close="handleClose">
        ...
        <div v-show="addEditDialog">
            <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="margin:20px;width:60%;min-width:300px;">
                <el-form-item label="房号名称" prop="name" :rules="[{ required: true, message: '房号名称不能为空'},]">
...
export default {
    data() {
        return {
            ...
            tableName: 'room_appointment_houses',
            formAction: "",
            dialogVisible: false,
            productId: '',
            infolists: []
    ...
    methods: {
        ...
        addInfo: function() {
            ...
            this.formAction = "/admin/roomAppointment/add-info";
        },
        editInfo: function(item) {
            ...
            this.listDialog = false;
            this.addEditDialog = true;
            this.formAction = "/admin/roomAppointment/edit-info?infoid=" + item.id;
        },
