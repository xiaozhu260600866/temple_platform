	...
	<section>
		<el-col :span="24" class="toolbar t-search float-r">
			<el-form :inline="true" id="search" :model="searchFields">
				...
				<el-form-item>
					<el-button type="primary" @click="$refs.createEdit.ajax('',1)">新增</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		<el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange" v-loading="data.listLoading">
			...
			<el-table-column label="操作" width="170">
				<template scope="scope">
					<el-button type="primary" size="mini" @click="$refs.createEdit.ajax(scope.row,1)">编辑</el-button>
...
export default {
	data() {
		return {
			formAction: '/admin/role/lists?type=1',
