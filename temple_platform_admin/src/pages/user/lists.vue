<template>
	<section>
		...
		<!-- 	<el-table-column prop="phone" label="推荐人" width="140">
			...
			<el-table-column label="姓名" min-width="100">
				<template scope="scope">
					<el-input size="small" v-model="scope.row.name"  @change="editField(scope.row,'name')"></el-input>
				</template>
		...
		<!-- 	 <el-table-column align="center" label="会员等级" width="80">
			...
			<el-table-column prop="phone" label="电话2" width="150">
				<template scope="scope">
					<el-input v-model="scope.row.phone2"  @change="editField(scope.row,'phone2')"></el-input>
				</template>
			</el-table-column>
			<el-table-column prop="phone" label="地址" min-width="100">
				<template scope="scope">
					<el-input v-model="scope.row.address"  @change="editField(scope.row,'address')"></el-input>
				</template>
			</el-table-column>
