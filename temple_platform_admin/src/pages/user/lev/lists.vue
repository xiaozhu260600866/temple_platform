<template>
	<section>
		...
		<el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange" v-loading="data.listLoading">
			...
			<el-table-column prop="name" label="会员等级" min-width="100"> </el-table-column>
			<el-table-column prop="amount" label="升级条件" min-width="50"> </el-table-column>
			<el-table-column align="center" prop="ratio" label="折扣" width="80"> </el-table-column>
...
export default {
	data() {
		return {
			formAction: '/admin/userLev/lists',
	...
	methods: {
		...
		handleDel(index, item) {
			this.del_vuex(item, index, this,'/admin/userLev/del')
		},
		delAll() { /*批量删除*/
			this.deleteAll(this,'/admin/userLev/delAll');
		},
		searchCallBack(res) {
