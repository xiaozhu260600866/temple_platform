<template>
    <!-- 上传规格 -->
    <el-dialog title="修改订单内容1222" :visible.sync="dialogVisible" size="tiny" :before-close="handleClose">
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="margin:20px;width:60%;min-width:300px;">
            ...
            <div v-if="type==2">
                <el-form-item label="快递" prop="express_name"  style="width:150px">
                ...
                <el-form-item label="单号" prop="express_no" >
                    <el-input v-model="ruleForm.express_no" style="width:150px"></el-input>
                </el-form-item>
            </div>
        </el-form>
