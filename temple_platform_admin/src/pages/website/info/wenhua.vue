<template>
    <section>
      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="margin:20px;width:60%;min-width:600px;">
         <el-form-item label="显示\隐藏" prop="can_wenhua" :rules="[{ required: true, message: '是否热销不能为空'}, ]">
                <el-switch v-model="ruleForm.can_wenhua" on-text="" off-text="" active-value="1" inactive-value="0"> </el-switch>
        </el-form-item>
        <div class="el-form-item">
            <label class="el-form-item__label" style="width:100px">上传图片</label>
            <my-upload upurl="product" :uploadLength="1" :fileList="ruleForm.wenhua_logo" :sizearr="300"></my-upload>
        </div>
        <div class="el-form-item" style="padding-left: 100px">
            <label class="el-form-item__label" style="width:100px;margin-left: -100px;">企业文化</label>
            <div class="el-form-item__content" style="">
                <myeditor :content="ruleForm.wenhua_content ? ruleForm.wenhua_content : ''" ref="editor"></myeditor>
            </div>
        </div>
        <el-form-item>
