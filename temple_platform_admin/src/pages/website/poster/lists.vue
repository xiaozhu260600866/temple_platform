<template>
    <section>
        <el-col :span="24" class="toolbar t-search float-r">
         ...
         <el-col :span="24">
            <el-tabs v-model="type" type="card" @tab-click="clickStatus">
                ...
                <el-tab-pane label="首页导航" :name="''+5"></el-tab-pane>
            </el-tabs>
        </el-col>
        <el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange" v-loading="data.listLoading">
            ...
            <el-table-column prop="url" label="url地址" min-width="130"> </el-table-column>
...
export default {
    data() {
        return {
            formAction: '/admin/website/poster/lists',
            data: this.formatData(this),
            siteName: this.getSiteName(),
            tableName: 'website_posters',
            sels: [], //列表选中列,
