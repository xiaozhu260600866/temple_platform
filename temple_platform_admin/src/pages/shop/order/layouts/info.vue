<template>
    <!-- 上传规格 -->
    <el-dialog title="修改订单内容" :visible.sync="dialogVisible" size="tiny" :before-close="handleClose" width="600px">
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            <div v-if="type==0">
                <!-- 列表 -->
                <div class="el-form-item">
                    <el-form-item label="旧价格">
                        <el-input placeholder="请输入内容" v-model="ruleForm.amount" :disabled="true" style="width: 200px"></el-input>
                    </el-form-item>
                </div>
                <div class="el-form-item">
                    <el-form-item label="新价格" prop="amount" :rules="[{ required: true, message: '新价格不能为空'}, ]">
                        <el-input v-model="ruleForm.amount" style="width: 200px"></el-input>
                    </el-form-item>
                </div>
            </div>
            <div v-if="type==1">
                <el-form-item label="名称" prop="addr_name" :rules="[{ required: true, message: '名称不能为空'},]">
                    <el-input v-model="ruleForm.addr_name" style="width: 250px"></el-input>
                </el-form-item>
                <el-form-item label="电话" prop="addr_phone" :rules="[{ required: true, message: '电话不能为空'},]">
                    <el-input v-model="ruleForm.addr_phone" style="width: 250px"></el-input>
                </el-form-item>
                <el-form-item label="省" prop="addr_province" :rules="[{ required: true, message: '省不能为空'},]">
                    <el-input v-model="ruleForm.addr_province" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="市" prop="addr_city" :rules="[{ required: true, message: '市不能为空'},]">
                    <el-input v-model="ruleForm.addr_city" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="区" prop="addr_area" :rules="[{ required: true, message: '区不能为空'},]">
                    <el-input v-model="ruleForm.addr_area" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="地址" prop="addr_address" :rules="[{ required: true, message: '地址不能为空'},]">
                    <el-input v-model="ruleForm.addr_address" style="width: 90%"></el-input>
                </el-form-item>
            </div>
            <div v-if="type==2">
                <el-form-item label="快递" prop="express_name"  >
                    <el-select v-model="ruleForm.express_name" placeholder="请选择快递" style="width: 250px">
                ...
                <el-form-item label="单号" prop="express_no"  >
                    <el-input v-model="ruleForm.express_no" style="width: 250px"></el-input>
                </el-form-item>
            </div>
        </el-form>
